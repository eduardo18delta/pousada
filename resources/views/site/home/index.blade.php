...
<html lang="pt-br">
<head>
<title>Pousada Maramalde</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="Maramalde pousada">
...
<div class="super_container">
    ...
    <div class="home">
        ...
        <div class="home_container d-flex flex-column align-items-center justify-content-center">
            <div class="home_title"><h1>Ligue e reserve</h1></div>
                        ...
                        <div class="rooms_list">
                            <ul>
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <img src="images/cafe.png" alt="geladeira" class="icon-desc">
                                    <span>Café da manhã</span>
                                </li>
                                    <li class="d-flex flex-row align-items-center justify-content-start">
                                    <img src="images/geladeira.png" alt="geladeira" class="icon-desc">
                                    <span>Geladeira</span>
                                </li>
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <img src="images/tv.png" alt="televisão" class="icon-desc">
                                    <span>Tv</span>
                                </li>
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <img src="images/sky.png" alt="tv por assinatura" class="icon-desc">
                                    <span>Sky</span>
                                </li>
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <img src="images/cama.png" alt="cama box" class="icon-desc">
                                    <span>Cama Box</span>
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <img src="images/wifi.png" alt="rede wi-fi" class="icon-desc">
                                    <span>Wi-Fi</span>
                                </li>
                            </ul>
                        </div>
                        <div class="rooms_price">R$300/<span>Diária</span></div>
                        <div class="button rooms_button"><a href="#">Ligue e reserve!</a></div>
                    </div>
                </div>
                ...
                <div class="col-xl-6">
                    <div class="rooms_left_content">
                        ...
                        <div class="rooms_list">
                            <ul>
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <img src="images/cafe2.png" alt="geladeira" class="icon-desc">
                                    <span>Café da manhã</span>
                                </li>
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <img src="images/geladeira2.png" alt="geladeira" class="icon-desc">
                                    <span>Geladeira</span>
                                </li>
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <img src="images/tv2.png" alt="televisão" class="icon-desc">
                                    <span>Tv</span>
                                </li>
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <img src="images/sky2.png" alt="tv por assinatura" class="icon-desc">
                                    <span>Sky</span>
                                </li>
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <img src="images/cama2.png" alt="cama box" class="icon-desc">
                                    <span>Cama Box</span>
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <img src="images/wifi2.png" alt="rede wi-fi" class="icon-desc">
                                    <span>Wi-Fi</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 footer_col">
                                <div class="footer_info d-flex flex-column align-items-lg-end align-items-center justify-content-start">
                                    <div class="text-center">
                                        <div>Fone:</div>
                                        <div>(96) 99106-0562</div>
                                        <div>(96) 99146-0919</div>
                                        <div>(96) 99171-4246</div>
                                        <div>(96) 3326-1500</div>
                            ...
                            <div class="col-lg-4 footer_col">
                                <div class="footer_info d-flex flex-column align-items-center justify-content-start">
                                    <div class="text-center">
                                        <div>Endereço:</div>
                                        <div>Av. Costa e Silva, Nº276 - Centro. Ferreira Gomes-AP</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 footer_col">
                                <div class="footer_info d-flex flex-column align-items-lg-start align-items-center justify-content-start">
                                    <div class="text-center">
                                        <div>E-mail:</div>
                                        <div>pousadamaramalde@gmail.com</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/5d9f8972fbec0f2fe3b92597/default';
s1.charset='UTF-8';
